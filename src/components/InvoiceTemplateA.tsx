...
export default function InvoiceTemplateA({ data }: { data: InvoiceData }) {
  ...
  return (
    <div className="p-10 flex flex-col min-h-[297mm] text-[11px] leading-snug">
      ...
      {/* 7. Notice block (Seal + Disclaimer) */}
      <div className="flex items-start gap-4 mb-10">
        <div className="w-[70px] shrink-0">
          {data.company.sealDataUrl ? (
            <img src={data.company.sealDataUrl} alt="Company Seal" className="w-[70px] h-[70px] object-contain rounded-full mix-blend-multiply" />
          ) : (
